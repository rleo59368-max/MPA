...
if categoria_seleccionada:
    ...
    if not filtro.empty:
        ...
        for _, row in filtro.iterrows():
            size = 20 + row["Votos"]*2  # tamaño del globo según votos
            # Marcador transparente solo para el hover y posición
            ...
            # Imagen circular escalada según tamaño del marcador
            if pd.notna(row["Imagen"]) and row["Imagen"]:
                scale = size / 100  # escala proporcional
